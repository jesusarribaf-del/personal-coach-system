...
- Peso (kg):
- Cintura (cm):
- Kcal objetivo vigentes:
- Proteína objetivo (g/día):
- Adherencia media últimas 4 semanas (%):
...
## Log mensual (composición)

| Mes | Peso medio | Cintura | Sensación general | Notas |
|---|---|---|---|---|
| | | | | |

---

## Aprendizajes nutricionales
