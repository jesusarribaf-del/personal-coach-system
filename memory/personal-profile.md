...
- Nombre / cómo prefiere que le llamen: Jesús Arriba Fernández / Jesús
...
- Peso actual (kg): ~82 kg (referencia propia abr 2026); 81.7 kg media últimos 11 días Apple Health
- Altura (cm): 183 cm
- Condiciones médicas conocidas: ninguna
- Medicación habitual: ninguna
- Alergias / intolerancias: ninguna conocida
- Operaciones / lesiones relevantes: dolor crónico hombro derecho al final de etapa muay thai — actualmente sin manifestarse. Adormecimiento pie derecho en cinta (una vez, posiblemente cordones apretados).
- Última analítica completa: no recuerda cuándo — pendiente urgente
- Analítica recomendada: hemograma, hierro/ferritina, vit D, B12, magnesio, perfil lipídico, glucosa, HbA1c, TSH+T4 libre, testosterona total y libre, cortisol matinal
...
- Fuerza: Jefit Premium
- Cardio: app Workouts iPhone → Apple Salud
- Sueño: AutoSleep Premium (VFC promedio noche, no puntual al despertar)
- Meditación: Headspace Premium (principalmente para conciliar el sueño)
- **Preferencia: no añadir más apps sin motivo claro**

## Lo que sí funciona

- Batch cooking x2/semana
- Uso de apps de seguimiento (Jefit, AutoSleep, Strava, Apple Fitness, Headspace)
- Proteína en polvo (Amix Iso Whey) + creatina 5g/día (adherencia alta)
- 4 entrenamientos/semana sostenidos desde agosto 2025

## Preferencias de comunicación

- Tono preferido: directo, exigente, práctico — sin motivación vacía ni generalidades
- Formato preferido: análisis concreto con plan de acción ejecutable
- Le motiva el reto explícito pero va a rachas — el sistema debe funcionar sin motivación
- **Patrón de riesgo documentado**: disciplina alta en rachas, nula fuera de ellas. El cambio a Rovi (14/05) es el próximo punto de ruptura potencial — diseñar para absorberlo.
...
- Gym: Nine Fitness Cañaveral (Madrid)
- Tendencia positiva fuerte en actividad física 2026 vs 2025: pasos +70%, energía actividad +63%, minutos ejercicio +162%
- Allen Carr activo para cannabis (iniciado 29/04/2026, cese total 05/05/2026 — día 3 a fecha 08/05/2026)
- Historial de tabaco: dejó con Allen Carr, recayó por aburrimiento al final de Sodexo; actualmente sin tabaco desde ~feb 2026
